...
document.querySelectorAll("#tekst").innerHTML="Dit was te veel tekst";
var x=5;
var x=10;
x=12
let y=5;
...
let result=d+c
let tekst="hello"
let lijst=[{naam:"Rama",plaats:"mechelen"},{naam:"Rama",plaats:"mechelen"}]
let arr=[1,2,3,4]
let g;
g="5";
result=d*c
...
console.log("het resultaat is kleiner dan 10")
}
//ternary operator
let result;
